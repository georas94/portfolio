...
def parse_textract_json(file_path):
    ...
    for line in lines:
        ...
        decree_match = re.match(r"DÉCRET N° ([\d\-\s\/\w]+)", text)
        if decree_match:
            if current_decree:
        ...
        # Titre du décret
        if current_decree and not current_decree["title"] and text.startswith("promulguant"):
...
if __name__ == "__main__":
    ...
    with open("2024-0507.json", "w", encoding="utf-8") as f:
